# Farm2Home PowerShell Launcher from mini777 root
...
Start-Process powershell -ArgumentList "-NoExit", "-Command", "Set-Location '$scriptDir\farm2home\backend'; python -m uvicorn app.main:app --port 8000 --reload"

Start-Sleep -Seconds 2

# Start Frontend in a new window
Write-Host "[2/2] Launching Frontend on http://localhost:5173 ..." -ForegroundColor Yellow
Start-Process powershell -ArgumentList "-NoExit", "-Command", "Set-Location '$scriptDir\farm2home\frontend'; npm run dev"
